...
class bot:
    def __init__(self):
        ...
        self.versionfix = "Valbot v2.2.1" #add two spaces if version number is vx.x and remove spaces if vx.x.x
    ...
    def titlescreen(self):
        ...
        print(Style.RESET_ALL)
        print(Style.RESET_ALL + Fore.YELLOW + "MODIFIED TO SOME EXTENT BUT NOT THAT MUCH")
        print(Style.RESET_ALL + Fore.YELLOW + "——————————————————————————————————————————————————————")
        print(Style.RESET_ALL + Fore.YELLOW + "CHANGING FEW LINES IS WORKING")
        print(Style.RESET_ALL)
        return
    ...
    def searchforgame(self):
        ...
        print(Style.RESET_ALL)
        print(Fore.YELLOW + " [-] SEARCHING FOR START BUTTON MODIFIED")
    ...
    def inqueue(self):
        ...
        while True:
            ...
            if q is not None or q2 is not None:
                if q is not None:
                    print(Style.RESET_ALL)
                    print(Fore.GREEN + " [√] DETECTED IN QUEUE MODIFIED")
                    self.waitingforgame()
                if q2 is not None:
                    print(Style.RESET_ALL)
